...
# Hello there, I'm Vandana Fuloria

### Biotechnologist by Education | Front-End Developer by Passion

I'm a Front-End Developer with **1+ year of professional experience**, focused on building clean, responsive, and user-friendly web experiences.

Originally from Dehradun, Uttarakhand, I started my journey in biotechnology and eventually found my true calling in technology — where creativity meets logic and code becomes a canvas.
...
* 1+ year of professional experience in Front-End Development
* Experience working directly with multiple clients
* Strong focus on responsive, accessible and user-friendly interfaces
* Experience with React-based applications and Shopify development
...
* Developed and customized Shopify storefronts and themes
* Integrated APIs and worked with dynamic data
* Collaborated on UI implementation using Figma designs
